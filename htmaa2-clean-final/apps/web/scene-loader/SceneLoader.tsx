...
import { CablesLoader, DeskLoader, FloorLoader, KeyboardLoader, LightsLoader, MonitorLoader, MouseLoader, BustLoader, NoopLoader, createRenderScenes, PlantLoader, IrisLoader } from "./AssetLoaders";
...
function OperatingSystemStats() {
  ...
  return (<>
    ...
    <div>
      ...
      <span>Magi (C)1998 Hayleysoft, bv</span>
    </div>
    <br/>
  </>)
}
...
function ShowBios() {
  ...
  return (<>
    <div>
      <p>Magi, Hayleysoft, bv - 1998-2024</p>
      <h3>Components</h3>
      <ul>
...
export function SceneLoader() {
  ...
  useEffect(() => {
    ...
    manager.add('Loading Bust', BustLoader());
    manager.add('Loading iris', IrisLoader());
