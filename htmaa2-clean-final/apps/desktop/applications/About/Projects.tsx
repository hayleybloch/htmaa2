  ...
  function RenderEnglishContent() {
    return (
      ...
      <div>
        ...
        <div style={{ margin: '10px 0' }}>
          <video src="/images/Week 2/demonstration_video.mp4" controls className={styles['project-video']}></video>
  ...
  function RenderEnglishContent() {
    return (
      <div>
        ...
        <h3>Process Steps</h3>
      <div>
          - <strong>Model test geometry</strong> with overhangs/bridges.<br/>
          - <strong>Slice file in Cura</strong> (layer height, infill, supports).<br/>
          - <strong>Print test part.</strong><br/>
          - <strong>Scan object</strong> using photogrammetry/structured light.<br/>
          - <strong>Clean mesh</strong> in Meshmixer/Blender.
      </div>

        <h3>Documentation Photos</h3>
        <ProjectImage src="/images/Week 4/4w1.png" alt="Week 4 Project Documentation" label="CAD model, printer in action, finished test piece, scan screenshot, cleaned mesh" />

        <h3>Reflection</h3>
        <p><strong>What worked:</strong> Print handled overhangs well.</p>
        <p><strong>What didn't:</strong> Scan mesh had holes.</p>
        <p><strong>Next step:</strong> Integrate 3D printed parts into larger assemblies.</p>
      </div>
    );
  }
